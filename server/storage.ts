...
const supabaseUrl = process.env.VITE_SUPABASE_URL || "https://wvncdusvpfbdsnclynxl.supabase.co";
const supabaseKey = process.env.VITE_SUPABASE_ANON_KEY || "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Ind2bmNkdXN2cGZiZHNuY2x5bnhsIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzIwMjQyNjEsImV4cCI6MjA4NzYwMDI2MX0.aSNumnERTQ8L-74raclsbdIh3NDF6gDZKOn3mm8gEcg";
...
export class SupabaseStorage implements IStorage {
  ...
  private mapClient(row: any): Client {
    ...
    return {
      ...
      company: row.company, notes: row.notes, createdAt: new Date(row.created_at)
    };
  }
